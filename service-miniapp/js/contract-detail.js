    ...
    const stageTemplates = [
        {
            ...
            stages: [
                { name: '材料进场阶段', tasks: [{ name: '材料采购' }, { name: '材料运输' }, { name: '材料验收' }] },
                { name: '布管布线阶段', tasks: [{ name: '开槽施工' }, { name: '布管布线' }, { name: '水电检测' }] },
                { name: '安装阶段', tasks: [{ name: '开关插座安装' }, { name: '灯具安装' }, { name: '面板安装' }] },
                { name: '调试验收阶段', tasks: [{ name: '电路调试' }, { name: '水路调试' }, { name: '验收整改' }] }
            ]
        },
        {
            id: 'stage_tpl_002',
            ...
            stages: [
                { name: '材料准备', tasks: [{ name: '材料采购运输' }] },
                { name: '施工阶段', tasks: [{ name: '布管布线' }, { name: '安装调试' }] },
                { name: '验收阶段', tasks: [{ name: '验收整改' }] }
            ]
        }
    ];
